...
\draw (workspace) -- node[right, font=\scriptsize] {contains\;(1:N)} (channel);
\draw (user) -- node[left, font=\scriptsize] {posts\;(1:N)} (message);
\draw (message) -- node[below, font=\scriptsize] {belongs\_to\;(N:1)} (channel);
